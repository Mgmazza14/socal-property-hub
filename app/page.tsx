...
export default function PropertyHomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between">
      <div>
          ...
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
            ...
            <div className="flex flex-wrap items-center gap-6">
              <a href="mailto:mrgtm@sbcglobal.net" className="flex items-center gap-1.5 text-slate-300 hover:text-white font-medium transition">
                <Mail className="w-3.5 h-3.5 text-sky-400" /> mrgtm@sbcglobal.net
              </a>
              <a href="tel:8058893999" className="flex items-center gap-1.5 text-slate-300 hover:text-white font-medium transition">
                <Phone className="w-3.5 h-3.5 text-sky-400" /> Direct: (805) 889-3999
              </a>
            </div>
          </div>
        </div>
        ...
        <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            ...
            <a href="/" className="flex items-center gap-3">
              <div className="bg-cyan-900 text-white p-2.5 rounded-xl shadow-sm">
            ...
            <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
              <a href="#listings" className="text-slate-900 hover:text-cyan-900 transition">Available Rentals</a>
        ...
        <section className="relative bg-slate-900 text-white py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
          <div className="absolute inset-0 z-0">
            {/* The Actual Simi Valley Happy Face Hill image! */}
            ...
            <div className="bg-white/95 backdrop-blur-md p-4 sm:p-5 rounded-2xl shadow-2xl text-slate-800 text-left max-w-4xl mx-auto mt-8 border border-white/20">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
                ...
                <div className="md:col-span-2">
                  <a 
                    href="#listings" 
                    className="w-full bg-cyan-900 hover:bg-cyan-950 text-white font-bold py-2.5 rounded-xl text-xs flex items-center justify-center transition shadow-md"
                  >
        ...
        <section className="bg-white border-b border-slate-200 py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="flex items-center justify-center gap-3 text-slate-700">
              <CreditCard className="w-5 h-5 text-cyan-900 flex-shrink-0" />
              <span className="text-xs font-semibold">Easy Online Application &amp; Rent Payments</span>
            </div>
            <div className="flex items-center justify-center gap-3 text-slate-700">
              <Wrench className="w-5 h-5 text-cyan-900 flex-shrink-0" />
        ...
        <main id="listings" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-24">
              <Loader2 className="w-10 h-10 text-cyan-900 animate-spin mb-3" />
                    ...
                    <div className="p-6 flex-1 flex flex-col justify-between">
                      <div>
                        <div className="flex justify-between items-start mb-1 gap-2">
                          <a href={`/properties/${unit.id}`} className="font-bold text-slate-900 text-lg leading-snug hover:text-cyan-900 transition">
                            {unit.properties?.name}
                          </a>
                          <div className="text-right flex-shrink-0">
                            <span className="text-xl font-black text-cyan-900">${unit.rent_amount}</span>
        ...
        <section id="contact" className="bg-white border-t border-slate-200 py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="w-12 h-0.5 bg-cyan-900 mx-auto my-4" />
            ...
            <p className="text-xs text-cyan-900 font-medium mb-10">
            ...
            <form onSubmit={handleContactSubmit} className="space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-3.5 py-2.5 border border-cyan-900/60 rounded-none focus:outline-none focus:border-cyan-900 focus:ring-1 focus:ring-cyan-900 text-sm text-slate-800 bg-white"
                  />
                </div>
              ...
              <div className="text-center pt-4">
                <button 
                  ...
                  className="bg-cyan-900 hover:bg-cyan-950 text-white font-normal px-12 py-3.5 text-base tracking-wide transition shadow-sm disabled:opacity-50"
                >
      ...
      {/* Footer */}
      <footer className="bg-cyan-950 text-white py-14 px-4 sm:px-6 lg:px-8 border-t border-cyan-900">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <div className="bg-white text-cyan-900 p-2 rounded-xl shadow-sm">
                <Home className="w-6 h-6" />
              </div>
              <div>
            ...
            <div className="text-sm text-sky-100 font-light space-y-1 pt-2">
              <p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-sky-100 font-light">
              ...
              <li><a href="/pay-rent" className="hover:text-white transition">Pay Rent</a></li>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              <p className="text-sm font-semibold text-sky-200">Tenants</p>
              <a 
                href="/pay-rent"
                className="inline-block text-sm text-sky-100 hover:text-white underline transition"
              >
                Log In &amp; Pay Rent
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-cyan-900/80 text-center text-xs text-sky-200 font-light">
