                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-start mb-1 gap-2">
                        <a href={`/properties/${unit.id}`} className="font-bold text-slate-900 text-lg leading-snug hover:text-blue-600 transition">
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-2">
                      ...
                      <a href={`/properties/${unit.id}`} className="bg-blue-50 hover:bg-blue-100 text-blue-600 text-xs font-bold py-3 rounded-xl text-center transition">
                        Apply Online
                      </a>
                    </div>
